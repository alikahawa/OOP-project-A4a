...
public class TeacherTest {
    ...
    public void test_the_constructor() {
        User Simo = new Teacher("simo", "limo","0123","simo@gmail.com");
        assertTrue("User constructer is not working well", new Teacher("simo", "limo","","").getFirstName().equals("simo"));
    }
    ...
    public void test_the_constructor1() {
        User Simo = new Teacher("simo", "limo","0123","simo@gmail.com");
        assertTrue("User constructer is not working well", new Teacher("simo", "limo","","simo@gmail.com").getEmail().equals("simo@gmail.com"));
    }
    /**
    ...
    public void test_the_constructor2() {
        User Simo = new Teacher("simo", "limo","0123","simo@gmail.com");
        assertTrue("User constructer is not working well", new Teacher("simo", "limo","0123","simo@gmail.com").CheckPassword("0123"));
    }
    /**
    ...
    public void test_equals5(){
        Teacher S = new Teacher("1111","2","1234","1@");
        Teacher s1 = new Teacher("1111", "2","1234","1@");
        assertTrue("Equals method is not working well", s1.equals(S));
    }
